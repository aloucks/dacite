...
pub(crate) struct VkImportMemoryWin32HandleInfoNVWrapper {
    pub vks_struct: vks::nv_external_memory_win32::VkImportMemoryWin32HandleInfoNV,
...
pub struct ExportMemoryWin32HandleInfoNv {
    pub attributes: *const win32_types::SECURITY_ATTRIBUTES,
    pub dw_access: win32_types::DWORD,
    pub chain: Option<ExportMemoryWin32HandleInfoChainNv>,
}

#[derive(Debug)]
pub(crate) struct VkExportMemoryWin32HandleInfoNVWrapper {
    pub vks_struct: vks::nv_external_memory_win32::VkExportMemoryWin32HandleInfoNV,
