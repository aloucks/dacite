...
impl DebugReportCallbackExt {
    pub(crate) fn new(handle: vks::VkDebugReportCallbackEXT, instance: Instance, allocator: Option<AllocatorHelper>, callback_helper: ext_debug_report::CallbackHelper) -> Self {
...
struct Inner {
    ...
    callback_helper: ext_debug_report::CallbackHelper,
}
