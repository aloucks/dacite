...
impl AsNativeVkObject for Pipeline {
    type NativeVkObject = vk_sys::VkPipeline;
...
impl Pipeline {
    pub(crate) fn new(handle: vk_sys::VkPipeline, device: Device, allocator: Option<AllocatorHelper>) -> Self {
